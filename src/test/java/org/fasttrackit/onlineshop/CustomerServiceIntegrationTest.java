...
public class CustomerServiceIntegrationTest {
    ...
    public void testCreateCustomer_whenInvalididRequest_thenThrowException() {
	...
	public void testGetCustomer_whenNonExistingCustomer_thenThrowResourceNotFoundExeption(){
